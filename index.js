...
function __asyncjs__wait_for_input() { return Asyncify.handleAsync(async () => { return new Promise(function(resolve) { function check() { if (typeof stdinBuffer !== 'undefined' && stdinBuffer.length > 0) { resolve(); } else { setTimeout(check, 50); } } check(); }); }); }
